...
export default function HouseHoldUpdateForm(props) {
  const {
    id: idProp,
    houseHold: houseHoldModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = houseHoldRecord
      ? { ...initialValues, ...houseHoldRecord }
      : initialValues;
  ...
  const [houseHoldRecord, setHouseHoldRecord] =
    React.useState(houseHoldModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(HouseHold, idProp)
        : houseHoldModelProp;
      setHouseHoldRecord(record);
    };
    queryData();
  }, [idProp, houseHoldModelProp]);
  React.useEffect(resetStateValues, [houseHoldRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            HouseHold.copyOf(houseHoldRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "HouseHoldUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || houseHoldModelProp)}
